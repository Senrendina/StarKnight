...
GunSwordTransform = WeaponAbility:new()

function GunSwordTransform:init()
...
function GunSwordTransform:update(dt, fireMode, shiftHeld)
...
function GunSwordTransform:transform()
...
function GunSwordTransform:aiming()
...
function GunSwordTransform:revert()
  self.weapon:setStance(self.stances.transforming)
  self.weapon:updateAim()
...
function GunSwordTransform:firePosition()
  return vec2.add(mcontroller.position(), activeItem.handPosition(self.fireOffset))
end

function GunSwordTransform:energyPerShot()
  return self.energyUsage * self.fireTime * (self.energyUsageMultiplier or 1.0)
end

function GunSwordTransform:reset()
  animator.setAnimationState("weapon", "sword")
  self.transformed = false
end

function GunSwordTransform:uninit()
  self:reset()
end
